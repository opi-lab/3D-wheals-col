...
2*sqrt(2*log(2))*1.7*x(3)
%% ---------Plot 3D Image-------------
figure(1)
C = del2(Z);
mesh(X,Y,Z) %plot data
hold on
surface(X,Y,D2GaussFunctionRot(x,xdata)) %plot fit
